...
def preprocess(df):
    ...
    count_vectorizer = joblib.load(vectorizer)



    vectorized=vectorizer.fit_transform(train_df['lemma'])


    X = train_df['lemma']
    count_vectorized=count_vectorizer.fit_transform(train_df['lemma'])
